...
namespace TransferConnexChatApp.SignalRHub
{
    public class ChatHub : Hub
    {
        ...
        public void Get_Connect(string username, string GroupName)
        {
            ...
            //Clients.Caller.BroadCastInGroup("Group Chat Hub", msg, list);
            //Clients.OthersInGroup(GroupName).GroupMessage("NewGroup", GroupName + " " + username + " " + id, count);

            //Clients.AllExcept(Exceptional).GroupMessage("NewConnection", username + " " + id, count);
        }
        ...
        public override System.Threading.Tasks.Task OnConnected()
        {
            ...
            //Clients.Caller.PublicMessage("NewJoin", clientId);
            //Clients.All.PublicMessage("NewJoin", clientId);
            //string[] Exceptional = new string[1];
            //Exceptional[0] = clientId;
            //Clients.AllExcept(Exceptional).PublicMessage("NewJoin", clientId);
