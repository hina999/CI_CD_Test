...
{
    public class StagingDealMap : EntityTypeConfiguration<StagingDeal>
    {
        public StagingDealMap()
        {
            // Primary Key
            this.HasKey(t => t.StagingDealId);
            ...
            this.Property(t => t.ImportFileName)
                .HasMaxLength(50);

            // Table & Column Mappings
            this.ToTable("StagingDeal");
            ...
            this.Property(t => t.IsDealProceeded).HasColumnName("IsDealProceeded");
            ...
            this.Property(t => t.ImportBy).HasColumnName("ImportBy");
        }
    }
}
